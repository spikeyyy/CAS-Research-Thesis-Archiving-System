					...
					<tbody>
						...
						while ($row = $qry->fetch_assoc()):
							...
							<tr>
								...
								<td>
									<?php echo ($row['archive_code']) ?>
								</td>
								<td>
									<?php echo ucwords($row['title']) ?>
								</td>
								<td>
									<?php echo $cur_arr[$row['curriculum_id']] ?>
								</td>
								<td class="text-center">
									<?php
									switch ($row['status']) {
										case '1':
											echo "<span class='badge badge-success badge-pill'>Uploaded</span>";
											break;
										case '0':
											echo "<span class='badge badge-secondary badge-pill'>Not Uploaded</span>";
											break;
									}
									?>
								</td>
