...
<div class="content py-4">
    <div class="card card-outline card-primary shadow rounded-0">
        <div class="card-header rounded-0">
            <h5 class="card-title">
                <?php echo isset($id) ? "Update Archive-{$archive_code} Details" : "Submit Project"; ?>
            </h5>
    ...
    $(function () {
        ...
        $('#archive-form').submit(function (e) {
            ...
            $.ajax({
                ...
                error: err => {
                    console.log(err)
                    el.text("Project successfully submitted. For evaluation in Research Office to publish")
