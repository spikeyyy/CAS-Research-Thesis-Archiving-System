...
if (isset($_GET['id'])) {
    ...
    $qry = $conn->query("SELECT * FROM archive_list where `status` = 1 and id = '{$_GET['id']}' ");
    if ($qry->num_rows > 0) {
    ...
    <div class="col-12">
        <div class="card card-outline card-primary shadow rounded-0">
            <div class="card-body rounded-0">
                <h2>Archive List of
                    <?= isset($curriculum['name']) ? $curriculum['name'] : "" ?>
                </h2>
                <p><small>
                        <?= isset($curriculum['description']) ? $curriculum['description'] : "" ?>
                    </small></p>
                <hr class="bg-navy">
                <?php
                        ...
                        <a href="./?page=view_archive&id=<?= $row['id'] ?>"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-7 col-sm-12">
                                    <h3 class="text-navy"><b>
                                            <?php echo $row['title'] ?>
                                        </b></h3>
                                    <small class="text-muted">By <b class="text-info">
                                            <?= isset($student_arr[$row['student_id']]) ? $student_arr[$row['student_id']] : "N/A" ?>
                                        </b></small>
                                    <p class="truncate-5">
                                        <?= $row['abstract'] ?>
                                    </p>
            ...
            <div class="card-footer clearfix rounded-0">
                <div class="col-12">
                    <div class="row">
                        <div class="col-md-6"><span class="text-muted">Display Items:
                                <?= $archives->num_rows ?>
                            </span></div>
                        <div class="col-md-6">
