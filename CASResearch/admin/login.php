...
<body class="hold-transition ">
  ...
  <style>
    ...
    body{
      background-image: linear-gradient(rgba(0.5, 0.5, 0.5, 0.5), rgba(10, 0, 45, 0.5)), url("<?php echo validate_image($_settings->info('cover')) ?>");
        ...
        <div class="card col-sm-12 col-md-6 col-lg-3 card-outline card-primary">
          ...
          <div class="card-body">
            <form id="login-frm" action="" method="post">
              ...
              <div class="row">
                <div class="col-8">
                  <button class="btn"><a href="<?php echo base_url ?>">Cancel</a></button>
                </div>
                <!-- /.col -->
                <div class="col-4">
